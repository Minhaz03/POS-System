<x-layouts.admin title="Create Category">
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <div>
            <h2 style="font-size:22px;font-weight:800;color:#0f172a;margin:0;">Create New Category</h2>
            <p style="font-size:13.5px;color:#64748b;margin:4px 0 0 0;">Add a new category to group products.</p>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="e.g. Pastries">
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <textarea name="description" id="description" rows="4" class="form-control" placeholder="Brief details about the category...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
