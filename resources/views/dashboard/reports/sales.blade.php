<x-layouts.admin title="Sales Report">
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <div>
            <h2 style="font-size:22px;font-weight:800;color:#0f172a;margin:0;">Sales Report</h2>
            <p style="font-size:13.5px;color:#64748b;margin:4px 0 0 0;">View detailed sales performance and revenue.</p>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom:24px;">
        <div class="card-body">
            <form method="GET" action="{{ route('dashboard.reports.sales') }}" style="display:flex;gap:16px;align-items:flex-end;flex-wrap:wrap;">
                ...
                <div style="display:flex;gap:10px;">
                    ...
                    <a href="{{ route('dashboard.reports.sales') }}" class="btn btn-outline">Clear</a>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:20px;margin-bottom:24px;">
        <div class="card">
            <div class="card-body" style="padding:16px 20px;">
                <div style="font-size:12px;font-weight:600;color:#64748b;text-transform:uppercase;margin-bottom:6px;">Total Sales (Gross)</div>
                <div style="font-size:24px;font-weight:800;color:#0f172a;">৳ {{ number_format($summary['total_sales'], 2) }}</div>
            </div>
        </div>
        <div class="card">
            <div class="card-body" style="padding:16px 20px;">
        ...
        <div class="card">
            <div class="card-body" style="padding:16px 20px;">
                <div style="font-size:12px;font-weight:600;color:#64748b;text-transform:uppercase;margin-bottom:6px;">Discounts Given</div>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:13.5px;text-align:left;">
                <thead>
                    <tr style="background:#f8fafc;border-bottom:1px solid #e2e8f0;color:#475569;">
                        ...
                        <th style="padding:12px 16px;text-align:center;">Items Sold</th>
                ...
                <tbody>
                    @forelse($sales as $sale)
                        <tr style="border-bottom:1px solid #f1f5f9;">
                            <td style="padding:12px 16px;">{{ $sale->sale_date->format('M d, Y') }}</td>
                            <td style="padding:12px 16px;font-family:monospace;color:#6366f1;font-weight:600;">
                                <a href="{{ route('dashboard.sales.show', $sale) }}" style="text-decoration:none;color:inherit;">{{ $sale->reference_no }}</a>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" style="padding:30px;text-align:center;color:#64748b;">No sales records found for the selected period.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
